...
export const FetchCompetences = async () => {
  ...
  // await delay(500)
  const result = await Axios.get("http://172.16.13.197:8080/api/comp/")
  return result.data
}
export const FetchVisibleCompetences = async () => {
  // await delay(500)
  const result = await Axios.get("http://172.16.13.197:8080/api/comp/visible")
  return result.data
}
const create = data => {
...
const FindVisible = () => {
  ...
  export const CreateCompetences = async (data) => {
    // await delay(500)
    const result = await Axios.post("http://172.16.13.197:8080/api/comp/create",data)
    return result.data
  }
